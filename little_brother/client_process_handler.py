...
class ClientProcessHandler(process_handler.ProcessHandler):
    ...
    def handle_event_kill_process(self, p_event, p_server_group=None, p_login_mapping=None) -> list[AdminEvent]:
    ...
    def kill_process_or_session(self, p_event, p_command_pattern,
