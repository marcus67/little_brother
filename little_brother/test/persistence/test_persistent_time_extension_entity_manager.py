...
from little_brother.test.persistence.base_persistent_entity_test import BasePersistentEntityManagerTest


class TestTimeExtensionEntityManager(BasePersistentEntityManagerTest):
