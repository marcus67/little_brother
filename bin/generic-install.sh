...
if [ ! -f $TMP_DIR/python-base-app-0.2.24.tar.gz ] ; then
  echo "ERROR: package python-base-app-0.2.24.tar.gz not found in $TMP_DIR!"
  echo "Download from test.pypi.org and execute again."
  exit 2
else
  echo "Package python-base-app-0.2.24.tar.gz was found."
fi
...
echo "  * python-base-app-0.2.24.tar.gz"
...
${PIP3} install --upgrade --force-reinstall \
     ...
     ${TMP_DIR}/python-base-app-0.2.24.tar.gz\
...
echo "Removing installation file ${TMP_DIR}/python-base-app-0.2.24.tar.gz..."
rm ${TMP_DIR}/python-base-app-0.2.24.tar.gz
