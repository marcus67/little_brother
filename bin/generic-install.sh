...
if [ ! -f $TMP_DIR/little-brother-0.4.8.tar.gz ] ; then
  echo "ERROR: package little-brother-0.4.8.tar.gz not found in $TMP_DIR!"
  echo "Download from test.pypi.org and execute again."
  exit 2
else
  echo "Package little-brother-0.4.8.tar.gz was found."
fi

if [ ! -f $TMP_DIR/python-base-app-0.2.22.tar.gz ] ; then
  echo "ERROR: package python-base-app-0.2.22.tar.gz not found in $TMP_DIR!"
  echo "Download from test.pypi.org and execute again."
  exit 2
else
  echo "Package python-base-app-0.2.22.tar.gz was found."
fi
...
echo "  * little-brother-0.4.8.tar.gz"
echo "  * python-base-app-0.2.22.tar.gz"
...
${PIP3} install --upgrade --force-reinstall \
     ${TMP_DIR}/little-brother-0.4.8.tar.gz\
     ${TMP_DIR}/python-base-app-0.2.22.tar.gz\
     ${TMP_DIR}/some-flask-helpers-0.2.2.tar.gz


echo "Removing installation file ${TMP_DIR}/little-brother-0.4.8.tar.gz..."
rm ${TMP_DIR}/little-brother-0.4.8.tar.gz
echo "Removing installation file ${TMP_DIR}/python-base-app-0.2.22.tar.gz..."
rm ${TMP_DIR}/python-base-app-0.2.22.tar.gz
