...
${PIP3} download -d $LIB_DIR --no-deps python_base_app==0.2.42
...
if [ ! -f $LIB_DIR/python-base-app-0.2.42.tar.gz ] ; then
  echo "ERROR: package python-base-app-0.2.42.tar.gz not found in $LIB_DIR!"
  echo "Download from test.pypi.org and execute again."
  exit 2
else
  echo "Package python-base-app-0.2.42.tar.gz was found."
fi
...
echo "  * python-base-app-0.2.42.tar.gz"
...
${PIP3} install --upgrade \
     ...
     ${LIB_DIR}/python-base-app-0.2.42.tar.gz\
...
echo "Removing installation file ${LIB_DIR}/python-base-app-0.2.42.tar.gz..."
rm ${LIB_DIR}/python-base-app-0.2.42.tar.gz
