...
if [ ! -f $TMP_DIR/little-brother-0.4.2.tar.gz ] ; then
  echo "ERROR: package little-brother-0.4.2.tar.gz not found in $TMP_DIR!"
  echo "Download from test.pypi.org and execute again."
  exit 2
else
  echo "Package little-brother-0.4.2.tar.gz was found."
fi
...
echo "  * little-brother-0.4.2.tar.gz"
...
${PIP3} install --upgrade --force-reinstall \
     ${TMP_DIR}/little-brother-0.4.2.tar.gz\
     ${TMP_DIR}/python-base-app-0.2.19.tar.gz\
     ${TMP_DIR}/some-flask-helpers-0.2.2.tar.gz


echo "Removing installation file ${TMP_DIR}/little-brother-0.4.2.tar.gz..."
rm ${TMP_DIR}/little-brother-0.4.2.tar.gz
